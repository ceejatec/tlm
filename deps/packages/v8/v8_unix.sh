...
cd v8
V8_ARGS="target_cpu=\"${TARGET_CPU}\" is_clang=false use_sysroot=false is_component_build=true v8_enable_backtrace=true v8_use_external_startup_data=false use_custom_libcxx=false v8_enable_pointer_compression=false"
